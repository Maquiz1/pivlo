                                        ...
                                        <table id="search-results" class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($override->AllTables() as $tables) {
                                                    ...
                                                    if (
                                                        $tables['Tables_in_pivlo'] == 'clients' ||
                                                        $tables['Tables_in_pivlo'] == 'facility' ||
                                                        $tables['Tables_in_pivlo'] == 'visit'
                                                    ) {
                                                ?>
                                                        <tr>
                                                            <td class="table-user">
                                                            ...
                                                            <td>
                                                                <input type="hidden" name="table_id" value="<?= $tables['Tables_in_pivlo']; ?>">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" name="table_name[]" id="table_name[]" value="<?= $tables['Tables_in_pivlo']; ?>" <?php if ($tables['Tables_in_pivlo'] != '') {
                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                        } ?>>
                                                                    <label class="form-check-label"><?= $tables['Tables_in_pivlo']; ?></label>
                                                                </div>
                                                            </td>
                                                            <td class="table-user">
                                                                <?= $override->getCount($tables['Tables_in_pivlo'], 'status', 1); ?>
                                                            </td>
                                                            <td class="table-user text-center">
                                                                <form method="post">
                                                                    <input type="hidden" name="data" value="<?= $x; ?>">
                                                                    <input type="hidden" name="table" value="<?= $tables['Tables_in_pivlo']; ?>">
                                                                    ...
                                                                    <hr>
                                                                    <a href="data.php?id=2&table=<?= $tables['Tables_in_pivlo'] ?>" role=" button" class="btn btn-info"> View Recoreds </a>
                                                                </form>
                                                            </td>
                                                        </tr>
                                                <?php $x++;
