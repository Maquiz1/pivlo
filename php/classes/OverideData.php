...
class OverideData
{
    ...
    {
        $query = $this->_pdo->query("SELECT MONTHNAME(visit_date) as monthname, SUM(status) as amount FROM facility GROUP BY monthname");
        $result = $query->fetchAll(PDO::FETCH_ASSOC);
        return $result;
    }
    ...
    {
        $query = $this->_pdo->query("SELECT MONTHNAME(visit_date) , site_id, COUNT(*) as count FROM facility GROUP BY visit_date, site_id");
        $result = $query->fetchAll(PDO::FETCH_ASSOC);
        return $result;
    }
    ...
    {
        $query = $this->_pdo->query("SELECT DATE_FORMAT(visit_date, '%Y-%m') AS month, gender, COUNT(*) AS count FROM facility GROUP BY month, gender");
        $result = $query->fetchAll(PDO::FETCH_ASSOC);
        return $result;
    }
    ...
    {
        $query = $this->_pdo->query("SELECT MONTHNAME(visit_date) AS monthname, site_id as site_id, COUNT(*) AS count FROM facility WHERE $where = '$value' GROUP BY monthname, site_id");
        $result = $query->fetchAll(PDO::FETCH_ASSOC);
        return $result;
    }
    ...
    {
        $query = $this->_pdo->query("SELECT MONTHNAME(visit_date) AS monthname, site_id as site_id, COUNT(*) AS count FROM facility WHERE $where = '$value' AND $where1 = '$value1' GROUP BY monthname, site_id");
        $result = $query->fetchAll(PDO::FETCH_ASSOC);
        return $result;
    }
